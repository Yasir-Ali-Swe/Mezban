...
export async function runReservationAgent({
  ...
  const agentPrompt = RESERVATION_AGENT_PROMPT.replace(/{RESTAURANT_NAME}/g, restaurantName || "our restaurant");
...
`;
  ...
  try {
    ...
    console.error("[Reservation Agent Error]:", err.message);
  }

  return `Thank you for choosing ${restaurantName} for your table reservation. How can I assist with your booking?`;
}
