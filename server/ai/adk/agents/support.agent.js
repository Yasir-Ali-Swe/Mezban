...
import { adkGetOrderTool, adkGetCustomerOrdersTool } from "../tools/index.js";
...
export const supportAgent = new LlmAgent({
  ...
  description:
    "Handles customer complaints, order issues, human assistance escalation, and order tracking support. Route here for customer support requests, problems, or complaints.",
...
1. LIVE STATUS LOOKUPS:
   - If the customer asks about the status of a specific order: use getOrder.
   - If the customer asks to check their previous orders: use getCustomerOrders.
...
2. TELEGRAM HTML FORMATTING:
  ...
  tools: [adkGetOrderTool, adkGetCustomerOrdersTool],
