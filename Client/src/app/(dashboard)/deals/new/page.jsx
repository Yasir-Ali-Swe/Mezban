...
const DealAdd = () => {
    ...
    // Handle form submission
    const onSubmit = async (values) => {
        // Convert selling price to number if it's a string
        ...
        try {
            ...
            formData.append('numberOfItems', dealItems.length.toString());
            formData.append('items', JSON.stringify(dealItems));
            ...
            // In real implementation, you would send formData to your backend
