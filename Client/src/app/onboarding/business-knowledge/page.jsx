                    ...
                    {isEcommerce ? (
                        ...
                        <div className="space-y-6">
                            ...
                            <KnowledgeTextarea
                                ...
                                placeholder="We deliver across Pakistan, including Lahore, Islamabad, Rawalpindi, Karachi, Faisalabad and other major cities. Standard delivery charges are Rs. 200. Orders are normally delivered within 3–5 business days. Delivery to remote areas may take longer. Free delivery is available on orders above Rs. 5,000. Customers will receive their order tracking information after the order has been shipped."
                                register={register}
                            ...
                            <KnowledgeTextarea
                                ...
                                placeholder="Cash on Delivery, Credit Card, Debit Card and Bank Transfer."
                                register={register}
                        ...
                        <div className="space-y-6">
                            ...
                            <KnowledgeTextarea
                                ...
                                placeholder="For delivery orders, customers can pay using Cash on Delivery, Credit Card, Debit Card or Bank Transfer. For dine-in customers, we accept Cash, Credit Card and Debit Card payments. Customers should confirm the available payment method when placing large or special orders."
                                register={register}
